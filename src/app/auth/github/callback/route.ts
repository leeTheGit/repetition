...
import { CreateUserFromOauth } from '@/core/user/actions/create-user-from-oauth'
...
export async function GET(request: Request): Promise<Response> {
    ...
    try {
        ...
        if (authIntent === 'signin') {
            ...
            const data = new TextEncoder().encode(githubUser.id + existingAccount.userId + APP_KEY);
